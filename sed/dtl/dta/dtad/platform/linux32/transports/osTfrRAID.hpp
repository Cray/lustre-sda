/*! \file osTfrRAID.hpp
    \brief  Implementation of CDriveTrustSession via the RAID CSMI 
...
#ifndef XPORT_TFR_CSMI_PASS_THROUGH_HPP
#define XPORT_TFR_CSMI_PASS_THROUGH_HPP
...
//=================================
#include <dta/Ata.hpp>
//#include <dta/platform/win32/OSIncludes.h> // nvn20110628
...
//
class CTfrRAID : public ata::CTfr
{
public:
   //================================================================
   //
   ...
   //
   //================================================================
   CTfrRAID( ata::etAddressMode addressMode );
...
#endif // XPORT_TFR_CSMI_PASS_THROUGH_HPP
