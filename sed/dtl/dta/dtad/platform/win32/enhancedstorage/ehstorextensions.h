...
//
// ENHANCED_STORAGE_COMMAND_CERT_INITIALIZE_TO_MANUFACTURED_STATE
//      This command will attempt to initialized to the manufactured state.
...
//      - ENHANCED_STORAGE_CAPABILITY_HASH_ALGS [ VT_VECTOR | VT_LPSTR]
//      - ENHANCED_STORAGE_CAPABILITY_ASYMMETRIC_KEY_CRYPTOGRAPHY [ VT_VECTOR | VT_LPSTR]
//      - ENHANCED_STORAGE_CAPABILITY_SIGNING_ALGS [ VT_VECTOR | VT_LPSTR]
...
#define CERT_CAPABILITY_CERT_EXTENSION_PARSING      0x4
...
//  [ VT_VECTOR | VT_LPSTR] Propvariant containing a list of hash algorithm identifiers
// 
...
//  [ VT_VECTOR | VT_LPSTR ] Propvariant containing a list of esymmetric key cryptography supported
// 
...
//  [ VT_VECTOR | VT_LPSTR ] Propvariant containing a list of signing algorithm identifiers
// 
