...
objNewClass.Put "governsID", "1.2.840.113556.1.8000.2554.999999.1.3"
objNewClass.Put "rDNAttID", "cn"
objNewClass.Put "showInAdvancedViewOnly", True
objNewClass.Put "adminDisplayName", strClassName
objNewClass.Put "adminDescription", "xyratex Group Server class"
...
objNewClass.PutEx ADS_PROPERTY_APPEND, _
                ...
                "domainDNS")
objNewClass.Put "systemMayContain", "xyGroupServerKey"
...
objNewClass.Put "objectCategory", "CN=Class-Schema," & _
                    strSchemaNamingContext
objNewClass.Put "defaultObjectCategory", "CN=xyGroupServer," & _
                    strSchemaNamingContext
objNewClass.SetInfo
