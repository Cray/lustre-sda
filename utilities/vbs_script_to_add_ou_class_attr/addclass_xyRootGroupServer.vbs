...
Const strClassName = "xyRootGroupServer"  ' Class name.
...
objNewClass.PutEx ADS_PROPERTY_APPEND, _
                ...
                "domainDNS")
objNewClass.Put "systemMustContain", "xyGroupServerKey"
...
objNewClass.Put "objectCategory", "CN=Class-Schema," & _
                    strSchemaNamingContext
objNewClass.Put "defaultObjectCategory", "CN=xyRootGroupServer," & _
                    strSchemaNamingContext
objNewClass.SetInfo
