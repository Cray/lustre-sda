...
#define OBD_FAIL_OST_WRITE_DELAY	 0x236
...
#define OBD_FAIL_MGC_PAUSE_REQUEUE_T	 0x91f
...
/* OBDECHO */
#define OBD_FAIL_OBDECHO			0x2100
#define OBD_FAIL_OBDECHO_ALL_REQUEST_NET	0x2101
#define OBD_FAIL_OBDECHO_ALL_REPLY_NET		0x2102
