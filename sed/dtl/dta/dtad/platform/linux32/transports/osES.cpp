...
dta::DTA_ERROR COSDTSessionES::Open(const dta::DTIdentifier &identifier, const tUINT8 protocol,
		                            const _tstring &optionString)//const std::wstring &optionString) // nvn20110628
{
   M_DriveTrustBaseTry()
   {
      FreeResources();
...
#if 0 //TODO: // nvn20110628 - osES_windows_api
      ...
      if (FAILED(hr))
      {
         dta::DTA_ERROR dtaError(dta::Error(errno)); // nvn20110628
         throw dtaError;
      }
                                                    ...
                                                    dta::tBytes &dataToRecv )
{
   M_DriveTrustBaseTry()
   {
      ...
      //tUINT8 functionID = tUINT8(spSpecific >> 8); //TODO: // nvn20110628 - osES_windows_api
