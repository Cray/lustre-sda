...
static const struct req_msg_field *empty_se[] = {
	&RMF_PTLRPC_BODY,
	&RMF_SELINUX
};
...
static const struct req_msg_field *mdt_swap_layouts_se[] = {
	&RMF_PTLRPC_BODY,
	&RMF_MDT_BODY,
	&RMF_SWAP_LAYOUTS,
	&RMF_CAPA1,
...
static const struct req_msg_field *ldlm_intent_layout_client_se[] = {
	&RMF_PTLRPC_BODY,
	&RMF_DLM_REQ,
	&RMF_LDLM_INTENT,
	&RMF_LAYOUT_INTENT,
...
static const struct req_msg_field *mds_get_root_client_se[] = {
	&RMF_PTLRPC_BODY,
	&RMF_MDT_BODY,
	&RMF_SELINUX,
	&RMF_NAME,
...
struct req_format RQF_MDS_GET_ROOT_SE =
	DEFINE_REQ_FMT0("MDS_GET_ROOT_SE", mds_get_root_client_se, mdt_body_capa);
EXPORT_SYMBOL(RQF_MDS_GET_ROOT_SE);
...
struct req_format RQF_MDS_GETATTR_SE =
	DEFINE_REQ_FMT0("MDS_GETATTR_SE", mdt_body_capa_se, mds_getattr_server);
...
struct req_format RQF_MDS_GETXATTR_SE =
        DEFINE_REQ_FMT0("MDS_GETXATTR_SE",
                        mds_getxattr_client_se, mds_getxattr_server);
...
struct req_format RQF_MDS_GETATTR_NAME_SE =
        DEFINE_REQ_FMT0("MDS_GETATTR_NAME_SE",
                        mds_getattr_name_client_se, mds_getattr_server);
...
struct req_format RQF_MDS_REINT_CREATE_SE =
        DEFINE_REQ_FMT0("MDS_REINT_CREATE_SE",
                        mds_reint_create_client_se, mdt_body_capa);
...
struct req_format RQF_MDS_REINT_LINK_SE =
	DEFINE_REQ_FMT0("MDS_REINT_LINK_SE",
			mds_reint_link_client_se, mdt_body_only);
...
struct req_format RQF_MDS_REINT_SETATTR_SE =
	DEFINE_REQ_FMT0("MDS_REINT_SETATTR_SE",
			mds_reint_setattr_client_se, mds_setattr_server);
...
struct req_format RQF_MDS_REINT_SETXATTR_SE =
        DEFINE_REQ_FMT0("MDS_REINT_SETXATTR_SE",
                        mds_reint_setxattr_client_se, mdt_body_only);
...
struct req_format RQF_LDLM_INTENT_LAYOUT_SE =
	DEFINE_REQ_FMT0("LDLM_INTENT_LAYOUT_SE",
			ldlm_intent_layout_client_se, ldlm_enqueue_lvb_server);
EXPORT_SYMBOL(RQF_LDLM_INTENT_LAYOUT_SE);
...
struct req_format RQF_LDLM_INTENT_GETATTR_SE =
	DEFINE_REQ_FMT0("LDLM_INTENT_GETATTR_SE",
			ldlm_intent_getattr_client_se, ldlm_intent_getattr_server);
...
struct req_format RQF_LDLM_INTENT_UNLINK_SE =
	DEFINE_REQ_FMT0("LDLM_INTENT_UNLINK_SE",
			ldlm_intent_unlink_client_se, ldlm_intent_server);
...
struct req_format RQF_MDS_READPAGE_SE =
	DEFINE_REQ_FMT0("MDS_READPAGE_SE",
			mdt_body_capa_se, mdt_body_only);
...
struct req_format RQF_MDS_SWAP_LAYOUTS_SE =
	DEFINE_REQ_FMT0("MDS_SWAP_LAYOUTS_SE",
			mdt_swap_layouts_se, empty);
EXPORT_SYMBOL(RQF_MDS_SWAP_LAYOUTS_SE);
