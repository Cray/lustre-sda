                                  ...
                                  struct mdd_rebuild_ent *rent)
{
        ...
        mdd_txn_param_build(env, mdd, MDD_TXN_REBUILD_OP);
                               ...
                               struct mdd_rebuild_thread *th)
{
        ...
        while (rent != NULL) {
                ...
                if (lu_fid_eq(&th->mr_last_fid, &th->mr_cur_fid)) {
                        ...
                        seq_client_alloc_fid(ri->ri_seq, &th->mr_new_fid, env);
                            ...
                            struct mdd_rebuild_info *ri)
{
        ...
        if (dt_try_as_dir(env, dir)) {
                ...
                seq_client_alloc_fid(ri->ri_seq, &root_fid, env);
                mdd_txn_param_build(env, ri->ri_mdd, MDD_TXN_REBUILD_OP);
