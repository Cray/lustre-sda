...
void lustre_assert_wire_constants(void)
{
	  ...
	  * running on Linux panda 2.6.32-431.17.1.el6.centos.plus.x86_64 #1 SMP Thu May 8 02:18:11 UT
	...
	CLASSERT(LOV_MAXPOOLNAME == 15);
	LASSERTF((int)offsetof(struct lmv_stripe_md, mea_pool_name[15]) == 31, "found %lld\n",
		 (long long)(int)offsetof(struct lmv_stripe_md, mea_pool_name[15]));
	LASSERTF((int)sizeof(((struct lmv_stripe_md *)0)->mea_pool_name[15]) == 1, "found %lld\n",
		 (long long)(int)sizeof(((struct lmv_stripe_md *)0)->mea_pool_name[15]));
