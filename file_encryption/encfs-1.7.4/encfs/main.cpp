...
{
     const char* RpcServer = get_attr_value("RPC_SERVER");
     
    //Initialize gss rpc client global object ...
     g_keyclient = lrpc_keyclient((char*)RpcServer, SERVICE_GSS); 	    
    ...
    //Destroy gss rpc client ...
    lrpc_destroy_client(g_keyclient);
