...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF(MDS_OPEN_BY_FID == 000040000000UL, "found 0%.11oUL\n",
        ...
        LASSERTF((int)offsetof(struct changelog_rec, cr_tfid) == 48, "found %lld\n",
        ...
        LASSERTF((int)offsetof(struct changelog_rec, cr_pfid) == 64, "found %lld\n",
        ...
        LASSERTF((int)sizeof(((struct changelog_rec *)0)->cr_uid) == 4, "found %lld\n",
                 (long long)(int)sizeof(((struct changelog_rec *)0)->cr_uid));
        LASSERTF((int)offsetof(struct changelog_rec, cr_gid) == 36, "found %lld\n",
                 (long long)(int)offsetof(struct changelog_rec, cr_gid));
        LASSERTF((int)sizeof(((struct changelog_rec *)0)->cr_gid) == 4, "found %lld\n",
                 (long long)(int)sizeof(((struct changelog_rec *)0)->cr_gid));
        LASSERTF((int)offsetof(struct changelog_rec, cr_clnid) == 40, "found %lld\n",
                 (long long)(int)offsetof(struct changelog_rec, cr_clnid));
        LASSERTF((int)sizeof(((struct changelog_rec *)0)->cr_clnid) == 8, "found %lld\n",
                 (long long)(int)sizeof(((struct changelog_rec *)0)->cr_clnid));

        /* Checks for struct changelog_ext_rec */
        LASSERTF((int)sizeof(struct changelog_ext_rec) == 112, "found %lld\n",
        ...
        LASSERTF((int)offsetof(struct changelog_ext_rec, cr_uid) == 32, "found %lld\n",
                 (long long)(int)offsetof(struct changelog_ext_rec, cr_uid));
        LASSERTF((int)sizeof(((struct changelog_ext_rec *)0)->cr_uid) == 4, "found %lld\n",
                 (long long)(int)sizeof(((struct changelog_ext_rec *)0)->cr_uid));
        LASSERTF((int)offsetof(struct changelog_ext_rec, cr_gid) == 36, "found %lld\n",
                 (long long)(int)offsetof(struct changelog_ext_rec, cr_gid));
        LASSERTF((int)sizeof(((struct changelog_ext_rec *)0)->cr_gid) == 4, "found %lld\n",
                 (long long)(int)sizeof(((struct changelog_ext_rec *)0)->cr_gid));
        LASSERTF((int)offsetof(struct changelog_ext_rec, cr_clnid) == 40, "found %lld\n",
                 (long long)(int)offsetof(struct changelog_ext_rec, cr_clnid));
        LASSERTF((int)sizeof(((struct changelog_ext_rec *)0)->cr_clnid) == 8, "found %lld\n",
                 (long long)(int)sizeof(((struct changelog_ext_rec *)0)->cr_clnid));
        LASSERTF((int)offsetof(struct changelog_ext_rec, cr_tfid) == 48, "found %lld\n",
        ...
        LASSERTF((int)offsetof(struct changelog_ext_rec, cr_pfid) == 64, "found %lld\n",
        ...
        LASSERTF((int)offsetof(struct changelog_ext_rec, cr_sfid) == 80, "found %lld\n",
        ...
        LASSERTF((int)offsetof(struct changelog_ext_rec, cr_spfid) == 96, "found %lld\n",
