...
#ifndef XPORT_ATA_PASS_THROUGH_HPP
#define XPORT_ATA_PASS_THROUGH_HPP
...
///
//
class COSDTSessionATAPT : public COSDTSession, public ata::CAta
{
public:
   /// Constructor.
   COSDTSessionATAPT();
