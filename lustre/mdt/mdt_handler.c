...
static int mdt_connect(struct mdt_thread_info *info)
{
	...
	if (rc == 0) {
		/* To avoid exposing partially initialized connection flags,
		 * changes up to this point have been staged in
		 * reply->ocd_connect_flags. Now that connection handling has
		 * completed successfully, atomically update connect flags in
		 * the shared export data structure. LU-1623 */
...
static int mdt_start_ptlrpc_service(struct mdt_device *m)
{
        ...
        conf = (typeof(conf)) {
                .psc_nbufs           = MDS_NBUFS,
                .psc_bufsize         = MDS_BUFSIZE,
		.psc_nbufs_mem_max   = mdt_readpage_mem,
                .psc_max_req_size    = MDS_MAXREQSIZE,
                .psc_max_reply_size  = MDS_MAXREPSIZE,
        ...
        conf = (typeof(conf)) {
                .psc_nbufs           = MDS_NBUFS,
                .psc_bufsize         = MDS_BUFSIZE,
		.psc_nbufs_mem_max   = mdt_setattr_mem,
                .psc_max_req_size    = MDS_MAXREQSIZE,
                .psc_max_reply_size  = MDS_MAXREPSIZE,
        ...
        conf = (typeof(conf)) {
                .psc_nbufs           = MDS_NBUFS,
                .psc_bufsize         = MDS_BUFSIZE,
		.psc_nbufs_mem_max   = mdt_mdsc_mem,
        ...
        conf = (typeof(conf)) {
                .psc_nbufs           = MDS_NBUFS,
                .psc_bufsize         = MDS_BUFSIZE,
		.psc_nbufs_mem_max   = mdt_mdss_mem,
                .psc_max_req_size    = SEQ_MAXREQSIZE,
                .psc_max_reply_size  = SEQ_MAXREPSIZE,
        ...
        conf = (typeof(conf)) {
                .psc_nbufs           = MDS_NBUFS,
                .psc_bufsize         = MDS_BUFSIZE,
		.psc_nbufs_mem_max   = mdt_dtss_mem,
                .psc_max_req_size    = SEQ_MAXREQSIZE,
                .psc_max_reply_size  = SEQ_MAXREPSIZE,
        ...
        conf = (typeof(conf)) {
                .psc_nbufs           = MDS_NBUFS,
                .psc_bufsize         = MDS_BUFSIZE,
		.psc_nbufs_mem_max   = mdt_xmds_mem,
                .psc_max_req_size    = MDS_MAXREQSIZE,
                .psc_max_reply_size  = MDS_MAXREPSIZE,
