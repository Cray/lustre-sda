...
void NullCipher::encodedReadKey(const unsigned char *data, unsigned char *encReadKey, 
	const CipherKey &masterKey, bool checkKey)
{
}
   
void NullCipher::encodeWriteKey(const unsigned char *encWriteKey, unsigned char *data, 
...
int NullCipher::reEncodedKeySize() const
{
    return 0;
}
...
int NullCipher::encryptData(const CipherKey &key, unsigned char *_cipher_out,
...
int NullCipher::decryptData(const CipherKey &key, unsigned char *_plain_out,
